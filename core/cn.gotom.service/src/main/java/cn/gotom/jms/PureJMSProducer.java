...
public class PureJMSProducer
{
	...
	/**
	 * @param args
	 *            the destination name to send to and optionally, the number of messages to send
	 */
	public static void main(String[] args)
	{
		...
		/*
		 * Create connection. Create session from connection; false means session is not transacted. Create sender and text message. Send messages, varying text slightly. Send end-of-messages message. Finally, close connection.
		 */
		try
		{

...
public abstract class StringUtils
{
	...
	{
		System.out.println(StringUtils.isHexString("G0123456789ABCDEF"));
		System.out.println(StringUtils.isHexString("0123456789ABCDEFABC"));
		// int i = 0;
		// while (i < 200)
		// {
	...
	public static boolean isHexString(String str)
	{
		for (int i = str.length(); --i >= 0;)
		{
			...
			if ((chr >= 48 && chr <= 70) || (chr >= 65 && chr <= 70))
			{
				;
			}
			else
	...
	public static String random(int length)
	{
		...
		{
			password += String.valueOf((byte) (Math.random() * 10));
		}
		return password;
	}
	...
	public static boolean endsWithIgnoreCase(String str, String suffix)
	{
		...
		return lcStr.equalsIgnoreCase(lcStr);
	}
